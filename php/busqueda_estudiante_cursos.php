...
while ($fila = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
  //..$fila["id_usuario"].
    ...
    echo "<tr><td><img src='../fotos/$foto' class='img-thumbnail' width='55'></td><td>".$fila["documento"]."</td><td class='mayusculas'>".$fila["ape_estudiante"]." ".$fila["nom_estudiante"]."</td>";
    ...
    echo "<td><span class='btn btn-default'>$curso_compuesto</span></td><td>"; ?><a class="btn btn-info" onClick="cargarFormulario('formulario_estudiante_modificar.php?documento=<?php echo $fila["documento"]; ?>')" href="#"><span class="glyphicon glyphicon-search"></span></a> <?php echo"</td><td>"; ?><a  class="btn btn-warning" onClick="cargarFormulario('consulta_notas_curso_est.php?documento=<?php echo $fila["documento"]; ?>')" href="#"><span class="glyphicon glyphicon-search"></span></a> <?php echo"</td></tr>";
