...
//echo "la primera: $resultado_estado";
	...
	$uploadOk=0;
		...
		if($uploadOk==1){$foto=1;}else{$foto=0;}
			$consulta="INSERT INTO tbestudiante (nom_estudiante, ape_estudiante, documento, fecha_nac, sexo, rh, tel_estudiante,dir_estudiante, nom_padre_estudiante, tel_padre_estudiante, nom_madre_estudiante, tel_madre_estudiante, fecha_reg_estudiante, estado_estudiante, observacion_estudiante,foto)
			VALUES ('$nom_estudiante',
					'$ape_estudiante',
					'$documento',
					'$fecha_nac',
					'$sexo',
